  ...
  <div class="lsg">
   ...
   <div class="gouwuche">
    <div class="gouCar">
     ...
     <strong class="red"><c:choose><c:when test="${sessionScope.account !=null }">${requestScope.length } </c:when><c:otherwise>0 </c:otherwise></c:choose></strong>&nbsp;件&nbsp;|
     <strong class="red">￥ ${requestScope.sum }</strong> 
